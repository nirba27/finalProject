                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 text-md-left ml-3 mt-3">
                            ...
                            <h4 class="font-weight-normal">
                                ...
                                <br>Your audience is most likely to watch <span ng-if="x.genre.includes('Sports')==0" class="badge badge-pill badge-info" ng-repeat="x in geners|limitTo:3">#{{x.genre}}</span>
                                <br>And a top viewer of <span  ng-if="x.genre.includes('Sports')==0" class="badge badge-pill badge-info" ng-repeat="x in genres_tags">#{{x.genre}}</span><span class="badge badge-pill badge-info" ng-repeat="x in selectedGenre2">#{{x}}</span></h4>
                            </h4>
