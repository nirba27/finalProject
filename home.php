    ...
    <!--Section: More-->
      ...
      <section id="res" ng-hide="res">
          ...
          <div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
              <!--Indicators-->
              <ol ng-repeat="x in programs" class="carousel-indicators">
                  <li data-target="#{{x.cover}}" data-slide-to="{{$index}}"></li>
              </ol>
              <!--/.Indicators-->
              <!--Slides-->
              <div  ng-repeat="x in programs"  class="carousel-inner" role="listbox">
